...
2. Update variables below. This code has been written to modify a single attribute in a user profile and has been tested and used succesfully to modify 
   email addreses. This has not been tested on child values or on multiple values but may work with minor code changes.
...
/*#####################################################################################################################################################
################ O EDITS REUIRED BELOW THIS LINE OR IN OTHER FILES. ###################################################################################
#####################################################################################################################################################*/
function push() {
